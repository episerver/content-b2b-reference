...
cls
echo ######################################################################
echo #     Grab a tea or coffee, this could take around 4 to 5 mins       #
echo ######################################################################
echo #                                                                    #
echo #                         (  )   (   )  )                            #
echo #                          ) (   )  (  (                             #
...
"%InstallDir%%msBuildPath%" .\src\CombinedSample.sln /t:Clean,Build  >> Build\Logs\Build.log
...
echo ## Installing  EPiServer.Net.Cli ##
...
dotnet-episerver create-cms-database ".\src\Sample.Web\Sample.Web.csproj" -S "%SQLSERVER%" %ADDITIONAL_SQLCMD%  --database-name "%APPNAME%.Cms" --database-user "%user%" --database-password "%password%"
