...
namespace Sample.Web.Infrastructure.Settings;
...
public class GlobalSettingsSearchProvider : ContentSearchProviderBase<SettingsBase, ContentType>
{
    ...
    public override IEnumerable<SearchResult> Search(Query query)
    {
        ...
        foreach (var setting in             _contentLoader.GetChildren<SettingsBase>(contentLink: _settingsService.GlobalSettingsRoot))
        {
    ...
    protected override string GetEditUrl(SettingsBase contentData, out bool onCurrentHost)
    {
        ...
        return
            $"/episerver/Sample.Web.Infrastructure.Settings/settings#context=epi.cms.contentdata:///{contentLink.ID}&viewsetting=viewlanguage:///{language}";
    }
}