...
namespace Sample.Web.Features.Blocks.PageListBlock
{
    public class PageListBlockComponent : AsyncBlockComponent<Models.Blocks.PageListBlock>
    {
        ...
        protected override async Task<IViewComponentResult> InvokeComponentAsync(Models.Blocks.PageListBlock currentBlock)
        {
            ...
            ViewData.GetEditHints<PageListBlockViewModel, Models.Blocks.PageListBlock>()
